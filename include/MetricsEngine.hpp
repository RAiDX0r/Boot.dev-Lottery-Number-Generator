...
class MetricsEngine
{
 public:
   ...
   */
  std::map<unsigned int, unsigned int> CalculateNumberFrequency(const std::vector<DrawResult>& AllDraws, const GameDefinition& GameDef) const;
   ...
   */
  std::map<unsigned int, unsigned int> CalculateBallSkipMetrics(const std::vector<DrawResult>& AllDraws, const GameDefinition& GameDef) const;
   ...
   */
  std::pair<unsigned int, unsigned int> CalculateCalendarFrequency(const std::vector<DrawResult>& AllDraws, const GameDefinition& GameDef) const;
};
